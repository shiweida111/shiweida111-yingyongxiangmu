...
后端服务将运行在 `http://localhost:5173`

### 三、前端开发

1. 打开微信开发者工具
2. 选择"导入项目"，选择 `miniprogram` 目录
3. 配置自己的小程序 AppID（或选择测试号）
4. 点击"编译"运行小程序
...
- **后端端口**: 5173（见 3_app.py）
- **API地址**: `http://localhost:5173`（见 miniprogram/app.js）
- **大模型API**: 已配置在 3_app.py 中

## ⚠️ 注意事项

1. 后端和小程序需要同时运行才能正常使用
2. 如需更换API密钥，请修改 `backend/3_app.py` 中的 `OPENAI_API_KEY`
3. 开发时请确保网络连接正常
